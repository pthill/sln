								...
								<div class='order-common-list'>
									...
									<div class='goods-items '>
										<div class='goods-item goods-item-extra'>
											<div class='p-img'>
												<a href='${(domainUrlUtil.SLN_URL_RESOURCES)!}/product/${(product.id)!0}.html?type=1' target="_blank">
													<!--<#if product.source == 2>
													<img width="80" height="80" src='${(jdConfig.IMAGE_PATH_160)!}${product.masterImg!''}'>
													<#else>
													<img width="80" height="80" src='${(domainUrlUtil.SLN_IMAGE_RESOURCES)!}${product.masterImg!''}'>
													</#if>-->
													<img width="80" height="80" src='${(getImagePathMethod((product.source)!"",(product.productCode)!""))!''}${product.masterImg!''}'>
											...
											<div class='goods-msg'>
												<div class='goods-msg-gel'>
													<div class='p-name'>
														<a href='${(domainUrlUtil.SLN_URL_RESOURCES)!}/product/${(product.id)!0}.html?type=1' target='_blank'>${product.name1!''}</a>
													</div>
													<div class='p-state'>
