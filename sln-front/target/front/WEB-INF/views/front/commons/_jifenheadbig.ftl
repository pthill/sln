  	...
  	<div class='wrapper'>
			<div class='container'>
				<ul class='collect lh'>
					<li class='fore1'>
                        ...
                        <a href='${(domainUrlUtil.SLN_URL_RESOURCES)!}/index.html' >商城首页</a>
					</li>
				</ul>
				<ul class='shortcut-right lh jfeng-list'>
				<#if Session.memberSession??>
				   ...
				   <#else>
						<li class='fore1' id='loginbar'>
							<a href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/portal/login.html" class='login white'>你好，请登录</a>&nbsp;&nbsp;
							<a href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/portal/register.html" class='regist white'>免费注册</a>
						</li>
					</#if>
					<li class='fore2-1 ld ff-vip' style='padding-left:12px;'>
						<span></span>
						<a class="white" target="_blank" href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/portal/userCenter.html">会员中心</a>
					</li>
					<li class='fore3 ld app-ff menu' style="text-align:center;width: 126px;padding: 0 5px;">
						<div class="menubox">
							<div class="mu-line white">
								<span></span>
					...
					<li class='fore3 ld app-ff menu' style="text-align:center;width: 78px;padding: 0 5px;">
						<div class="menubox">
							...
							<div class="imgwx-ej khfw clearfix " style="display: none">
								<div class="white" style="text-align: left;">客户</div>
								<div class="item">
					...
					<li class='fore5 ld menu' id='site-nav'>
						<span></span>
						<a class="white" target="_blank" href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/store/step1.html">商家入驻</a>
					</li>
					<li class='fore5 ld menu' id='site-nav'>
						<span></span>
						<a class="white" href="#">联系我们</a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class='container' id='HeardTop'>
				<div class='ld' id='logo-img'>
					<a href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/jifen.html" target="_blank">
						<img alt="" src="${domainUrlUtil.SLN_STATIC_RESOURCES!}/img/fulilogo.png" >
					</a>
				</div>
				<div class='seach-box'>
					<div class='i-search ld'>
						...
						<div class='form'>
							<form action="${(domainUrlUtil.SLN_URL_RESOURCES)!}/jifen.html" method="get">
								...
								<button class="button" type='submit'>福利搜索</button>
							</form>
						</div>
					</div>
					<div id='Hotwords'>
