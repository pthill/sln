...
<div class='w1 header container'>
    ...
    <div style="padding-top: 45px;float: left;margin-left: -35px;">
        <a style="text-decoration: none" href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/cart/detail.html?cartSource=2">
            <span style="font-size: 16px;color:#FF8000;font-weight: 600">切换到福利购物车&nbsp;></span>
        </a>
    </div>
