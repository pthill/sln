...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="${(domainUrlUtil.SLN_STATIC_RESOURCES)!}/css/shop.css">
	...
	<script type="text/javascript" src="${(domainUrlUtil.SLN_STATIC_RESOURCES)!}/js/jquery.form.js"></script>
	...
	<#assign form=JspTaglibs["/WEB-INF/tld/spring-form.tld"]>
			...
			<div class='container'>
				<ul class='collect lh'>
					<li class='fore1'>
						<a href='javascript:void(0)' onclick="AddFavorite(window.location,document.title);return false;">收藏海核云谷</a>
					</li>
				</ul>
				<ul class='shortcut-right lh'>
				   ...
				   <#if user??>
				   		<li class='fore1' id='loginbar'>
							<a href='${(domainUrlUtil.SLN_URL_RESOURCES)!}/member/order.html' target="_blank" class='login'>${(user.name)!''}</a>&nbsp;&nbsp;
							<a href='${(domainUrlUtil.SLN_URL_RESOURCES)!}/logout.html'  onclick="logout()" class='regist'>退出</a>
						</li>
				   	 	<li class='fore2 ld'>
							<span></span>
							<a href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/member/order.html" target="_blank">我的订单</a>
						</li>	
				   	<#else>
						<li class='fore1' id='loginbar'>
							<a href='${(domainUrlUtil.SLN_URL_RESOURCES)!}/login.html' class='login'>你好，请登录</a>&nbsp;&nbsp;
							<a href='${(domainUrlUtil.SLN_URL_RESOURCES)!}/register.html' class='regist'>免费注册</a>
						</li>
				   </#if>
