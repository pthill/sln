				...
				<div class="left-box">
					<div class="mainImg">
						<a href="javascript:;">
							...
							<img style="width:360px;height:360px" jqimg="${(domainUrlUtil.SLN_IMAGE_RESOURCES)!}${(actGroup.image)!''}" src="${(domainUrlUtil.SLN_IMAGE_RESOURCES)!}${(actGroup.image)!''}" />
						</a>
					</div>
				</div>
				<div class="right-box">
					<div class="right-box-pad">
						...
						<div class="timeinfo">
							...
							<#else>
	          				...
	          				<div class="number-item">
								<span class="num">${(actGroup.virtualSaleNum + actGroup.saleNum)!0}</span>件已被抢<#if stageType!=3>，剩余库存：${(actGroup.stock)!0}</#if>
							</div>
						</div>
						
						<div id="Choose" class='p-choose-wrap tuan-choose-wrap'>
							<div id='ChooseNorm' class='li choosenorms'>
						...
						<div class="item-purch item-purch-tuan <#if stageType != 2 || actGroup.stock lt 1>over</#if>">
							<div class="item-flxed <#if stageType != 2 || actGroup.stock lt 1>item-flxed-over</#if>">
								...
								<a class="oldPrice oldPrice-span" href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/product/${(product.id)!0}.html" target="_blank">对比原商品<span class="simsun">>></span></a>
								<div class="btn-box">
									<#if stageType?? && stageType == 1 >
										<!-- 即将开始 -->
