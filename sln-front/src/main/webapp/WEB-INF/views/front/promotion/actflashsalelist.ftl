		        	...
		        	<#if saleProduct.product??>
				        <div class="item">
				            ...
				            <#if state==2>
				              ...
				              <#else>
				              	<span class="state-charterd" onclick="location.href='${(domainUrlUtil.SLN_URL_RESOURCES)!}/product/${(saleProduct.product.id)!0}.html?type=1'"></span>
				              </#if>
			                </#if>
					          ...
					          <a href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/product/${(saleProduct.product.id)!0}.html?type=1" class="disbox" title="${(saleProduct.product.name1)!''}">
