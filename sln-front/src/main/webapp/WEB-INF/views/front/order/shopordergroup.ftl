								...
								<div class='order-common-list'>
									...
									<div class='goods-items '>
										<div class='goods-item goods-item-extra'>
											<div class='p-img'>
												<a href='${(domainUrlUtil.SLN_URL_RESOURCES)!}/tuan/${(actGroup.id)!0}.html' target="_blank">
													<img width="80" height="80" src='${(domainUrlUtil.SLN_IMAGE_RESOURCES)!}${(actGroup.image)!""}'>
												</a>
											</div>
											<div class='goods-msg'>
												<div class='goods-msg-gel'>
													<div class='p-name'>
														<a href='${(domainUrlUtil.SLN_URL_RESOURCES)!}/tuan/${(actGroup.id)!0}.html' target='_blank'>${product.name1!''}</a>
													</div>
													<div class='p-state'>
