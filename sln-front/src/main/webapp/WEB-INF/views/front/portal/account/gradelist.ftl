		...
		<div class="main-fram">
			<div class="jifen_top">
				...
				<div class="fr">
					...
					<a href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/jifen.html" target="_blank" class="jf-btn">会员权益</a>
				</div>
			</div>
			<div class="content_tit">
				...
				<div class="fr coupon_fr">
					<a href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/news/2.html" target="_blank" class="colblue">经验值规则说明</a>
				</div>
			</div>
		...
		$("#gradelist").addClass("currnet_page");
          ...
          $(".pagination-container").pagination({
              ...
              backFn:function(page){  //回调函数
                  //page当前页码
                  window.location.href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/member/grade.html?rows=5&page="+page;
              }
          });
       });
</script>
