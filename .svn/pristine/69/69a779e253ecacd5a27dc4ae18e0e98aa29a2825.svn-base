...
<#assign currentBaseUrl="${domainUrlUtil.SLN_URL_RESOURCES}/seller/settlement"/>
	...
	$(function() {
		...
		$("#btn-uploadInvoice").click(function(){
			...
			$.messager.alert('提示','只有未上传的发票才可以上传。');
				...
				window.location.href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/seller/settlement/uploadInvoice?id="+selectedCode.id;
		});	
		<#--导出列表-->
		 $("#btn-importlist").click(function () {
            $.messager.confirm('提示', '确定导出平台结算吗？', function(r){
                if (r){
		...
		$("#btn-detail").click(function(){
			...
			if(!selectedCode){
	 		...
	 		window.location.href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/seller/settlement/detail?id="+selectedCode.id;
		});	
                          ...
                          <div class="col-lg-12 col-sm-12 col-xs-12">
                              <div class="row row-mgbot">
                                  <div class="col-lg-4 col-sm-6 col-xs-12">
                                  		...
                                  		<input type="text" id="q_settleCycle" name="q_settleCycle" value="${q_settleCycle!''}" />
                                  </div>
                                  <div class="col-lg-4 col-sm-6 col-xs-12">
                                  		<label class="lab-item">结算状态：</label>
                                  		 <@cont.select id="q_status" codeDiv="SETTLEMENT_STATUS" value="${q_status!''}" name="q_status" />
                                  </div>
                                   <div class="col-lg-4 col-sm-6 col-xs-12">
               	...
               	<div data-options="region:'center'" border="false">
					...
					<div id="gridTools">
						...
						<a id="btn-detail" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true">详情</a>
		  				...
		  				<@shiro.hasPermission name="/seller/settlement/importlist">
						<a id="btn-importlist" href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-print" plain="true">导出列表</a>
						</@shiro.hasPermission>
					
						<@shiro.hasPermission name="/seller/settlement/uploadInvoice">
