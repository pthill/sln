                ...
                <dd class="dd-group">
                    <div class="fluidbox">
                        ...
                        <p class="p6 p-item">
                            ...
                            <input type="text" id="order" name="order" class="txt w200 easyui-numberbox" missingMessage="请输入排序"
                    ...
                    <div class="fluidbox">
                        ...
                        <p class="p6 p-item">
                            ...
                            <input type="text" id="address"  name="address" class="txt w300 easyui-validatebox" data-options="required:true,validType:['code','length[1,35]']"/>
                        </p>
                    </div>
                    <div class="fluidbox">
                        <p class="p6 p-item">
                            <label class="lab-item">简介: </label>
                            <input type="text" id="description"  name="description" class="txt w200 easyui-validatebox" data-options="required:true,validType:['code','length[5,25]']"/>
                        </p>
                        <p class="p6 p-item">
