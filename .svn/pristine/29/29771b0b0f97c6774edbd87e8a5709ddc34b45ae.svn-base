...
public class ConstantsEJS {
    ...
    public final static String NAMESPACE_MOBILEMALL_WEB_MEMBER         = "sln:b2b2c:web:member";
    ...
    /**短信每日每人可发送最大条数*/
    public static final int    SMS_MAX_GIVEN_NUM                       = 20;
    /**短信最大有效时间（分钟）*/
    public static final int    SMS_MAX_WAIT_TIME                       = 10;
    /**角色是供应商类型*/
    public static final String SUPPLIER_TYPE                           ="1";
    /**角色是商家类型*/
    public static final String SELLER_TYPE                             ="0";
    /*业务管理方停用*/
    public static final String OPERATION_STATE                     ="0";
    /**供应商状态时禁用*/
    public static final int SUPPLIER_DOWN                           =0;
    /**供应商状态时启用*/
    public static final int SUPPLIER_UP                             =1;
