...
<script language="javascript">
    $(function () {
        ...
        $("#add").click(function () {
            ...
            var retroactionReason=$("#retroactionReason").val();
           if(retroactionReason==''){
           alert("反馈原因不能为空");
           return false;
           }
            if($("#addForm").form('validate')){
             window.location.href='${domainUrlUtil.SLN_URL_RESOURCES}${currentBaseUrl}/onregister/refuse?id=${(ProductRegister.id)!''}&reastion='+retroactionReason;
            }
        });
    ...
    <div class="formbox-a">
        ...
        <@form.form method="post" class="validForm" id="addForm" name="addForm" enctype="multipart/form-data">
            <dl class="dl-group">
             ...
             <dl class="dl-group">
                ...
                <dd class="dd-group">
                    ...
                    <textarea name="retroactionReason" id="retroactionReason" style="width:300px;height:120px" data-options="required:true,validType:'length[0,300]'" class="easyui-validatebox txt w280"></textarea>
                    </div>
                </dd>
            </dl>
            ...
            <p class="p-item p-btn">
                <input type="button" id="add" class="btn" value="审核不通过"/>
