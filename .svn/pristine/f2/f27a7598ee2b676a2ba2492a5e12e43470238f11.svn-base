...
<script type="text/javascript"
	src="${(domainUrlUtil.SLN_STATIC_RESOURCES)!}/resources/seller/jslib/js/jquery-1.8.2.min.js"></script>
<script type="text/javascript"
	src="${(domainUrlUtil.SLN_STATIC_RESOURCES)!}/resources/seller/jslib/js/jquery.jqprint-0.3.js"></script>
<script>
	$(function() {
...
<body id="printArea">
	...
	<div
		...
		货到付款 &nbsp;&nbsp; </#if> 订单支付金额：<span>￥${(orders.moneyOrder)?string("0.00")!""}</span>
	</div>
</body>
</html>