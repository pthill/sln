<div id="_memberSqecialintegrallog" class="easyui-dialog popBox" title="会员专项积分变更日志" style="width:800px;height:400px;" data-options="resizable:true,closable:true,closed:true,cache: false,modal: true">
	<div data-options="region:'center'" border="false" style="width:783px;height:358px;">
		<table id="memberSpecialintegrallogdataGrid" class="easyui-datagrid"
