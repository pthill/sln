...
public class SystemResources implements Serializable {
     ...
     * 资源使用范围：0、平台
     */
    public final static Integer SCOPE_ADMIN = 0;
    /**
     * 资源使用范围：1、平台+业务管理方
     */
    public final static Integer SCOPE_ADMIN_AND_OPERATION = 1;
    /**
     * 资源使用范围：2、商家
     */
    public final static Integer SCOPE_SELLER = 2;
    /**
     * 资源使用范围：3、商家和供应商
     */
    public final static Integer SCOPE_SELLER_AND_SUPPLIER  = 3;
    ...
    private String  scope;      //应用范围 0平台，1平台+业务管理方，2商家,3商家和供应商
