      ...
      <!-- S 阶梯竞价 -->
          <div class="group-cate-flxed">
            ...
            <div class="group-itemnav">
             ...
             <div class="dd">
                 <p class="item">
                 	<a class="item-a" href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/bidding-sale.html">进行中</a>
                 </p>
                 <p class="item">
                 	<a class="item-a item-a-cur" href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/bidding-start.html">未开始</a>
                 </p>
                 <p class="item">
              ...
              <div class="div-h3">
              	<#if actBiddingTypes??>
        			<#list actBiddingTypes as actBiddingType>
		                <h3 class="itemnav-h3">
		                  <a class="item-a <#if actBiddingType.id=type>item-a-cur</#if>" href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/bidding-start.html?type=${(actBiddingType.id)!}">${(actBiddingType.name)!""}</a>
		                </h3>
                	</#list>
                </#if>
              </div>
