                    ...
                    <div class="fluidbox">
                        <p class="p6 p-item">
                            ...
                            <select name="parkId" id="parkId" class="txt w160" data-options="required:true">
                                ...
                                <#if parks??>
                                    <#list parks as item>
                                        <option <#if service?? && service.parkId?? && service.parkId==item.id>selected</#if> value="${item.id}">${item.parkName}</option>
                                    </#list>
                                </#if>
                            </select>
                        </p>
                        <p class="p6 p-item">
                            ...
                            <input type="text" id="order" name="order" value="${service.order}" class="txt w150 easyui-numberbox" missingMessage="排序必填，1-5个字符" data-options="required:true,validType:'length[1,5]'"/>
                        </p>
                    </div>
                    <div class="fluidbox">
                        <p class="p6 p-item">
                            ...
                            <select name="fwx" id="fwx" class="txt w160" data-options="required:true">
                                ...
                                <#if fwx??>
                                    <#list fwx as item>
                                    <option value="${item.id}" <#if service.fwx??&&service.fwx==item.id?string>selected</#if>>${item.serviceName}</option>
                                    </#list>
                                </#if>
                            </select>
                        </p>
                        <p class="p6 p-item">
                            ...
                            <select name="serviceId" id="serviceId" class="txt w160" data-options="required:true">
                                ...
                                <#if fwl??>
                                    <#list fwl as item>
                                    <option value="${item.id}" <#if service??&& service.serviceId??&&service.serviceId==item.id>selected</#if> >${item.serviceName}</option>
                                    </#list>
                                </#if>
                            </select>
                        </p>
