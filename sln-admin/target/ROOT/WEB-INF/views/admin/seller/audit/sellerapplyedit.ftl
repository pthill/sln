...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">修改商家申请<span class="s-poar"><a class="a-back" href="${domainUrlUtil.SLN_URL_RESOURCES}/admin/seller/audit">返回</a></span></h2>
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<a href="${domainUrlUtil.SLN_IMAGE_RESOURCES}${(sellerApply.bussinessLicenseImage)!''}" target="_blank">点击查看</a>
						</p>
					</div>
					<div class="fluidbox">
						<p class="p12 p-item">
				...
				<dd class="dd-group">
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<input class="easyui-validatebox txt w280" type="text" id="userName" name="userName" value="${(userName)!''}" data-options="required:true,validType:['code','length[3,16]']" >
						</p>
					</div>
					<div class="fluidbox">
						<p class="p12 p-item">
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<input class="easyui-validatebox txt w280" type="text" id="sellerName" name="sellerName"  value="${(sellerName)!''}" data-options="required:true,validType:['code','length[2,20]']"  >
						</p>
					</div>
					<div class="fluidbox">
						<p class="p12 p-item">
                            ...
                            <p class="p12 p-item">
								...
								<#list park.operationNames?split(",") as name>
									<#list codeManager.codeMap['OPERATION_NAME'] as code>
										<#if name==code.codeCd>
                                            <input type="checkbox" name="operationId_${park.id}" <#if operation?contains("${park.id}_${code.codeCd}")>checked</#if> value="${name}"><span>${code.codeText!''}</span>
										</#if>
									</#list>
								</#list>
                            </p>
