...
$(function(){
	...
	$("#add").click(function(){
		if($("#addForm").form('validate')){
	 		$("#addForm").attr("action", "${domainUrlUtil.SLN_URL_RESOURCES}/admin/actbiddingbanner/banner/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">修改集合竞价首页轮播图<span class="s-poar"><a class="a-back" href="${domainUrlUtil.SLN_URL_RESOURCES}/admin/actbiddingbanner/banner">返回</a></span></h2>
					...
					<div class="fluidbox">
						<p class="p12 p-item">
							...
							<#if (actBiddingBanner.image)??> 
									&nbsp;&nbsp;&nbsp;&nbsp;<a href="${domainUrlUtil.SLN_IMAGE_RESOURCES}${(actBiddingBanner.image)!''}" class="colorbox">查看图片</a>
							</#if>
						</p>
						<p class="p12 p-item">
							<label class="lab-item">&nbsp;</label>
