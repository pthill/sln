				...
				<div class="fluidbox">
					<p class="p12 p-item">
						<label class="lab-item">投诉时间:</label> 
						  <input type="text" id="complainTime" name="complainTime" value="${(complainRegister.complainTime?string('yyyy-MM-dd HH:mm:ss'))!''}" class="txt w200 easyui-validatebox" required
                                   onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'complainTime\')}'});" />
					</p>
				</div>
				<div class="fluidbox">
						<p class="p12 p-item">
