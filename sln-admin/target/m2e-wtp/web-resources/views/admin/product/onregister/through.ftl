...
<script language="javascript">
    $(function () {
        ...
        $("#add").click(function () {
               window.location.href='${domainUrlUtil.SLN_URL_RESOURCES}${currentBaseUrl}/onregister/Auditing?id=${(ProductRegister.id)!''}';
    ...
    <div class="formbox-a">
        ...
        <@form.form method="post" class="validForm" id="addForm" name="addForm" enctype="multipart/form-data">
            ...
            <p class="p-item p-btn">
                <input type="button" id="add" class="btn" value="审核通过"/>
