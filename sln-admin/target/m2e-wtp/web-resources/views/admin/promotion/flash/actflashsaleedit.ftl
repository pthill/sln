	...
	$("#add").click(function(){
		...
		if($("#addForm").form('validate')){
			...
			if (auditRule == null || auditRule == "") {
	 		...
	 		$("#addForm").attr("action", "${domainUrlUtil.SLN_URL_RESOURCES}/admin/promotion/flash/update")
  				 .attr("method", "POST")
  				 .submit();
  		}
	});
...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">修改整点秒杀<span class="s-poar"><a class="a-back" href="${domainUrlUtil.SLN_URL_RESOURCES}/admin/promotion/flash">返回</a></span></h2>
			...
			<dl class="dl-group">
				...
				<dd class="dd-group">
					...
					<div class="fluidbox addItemT">
							<label class="lab-item">&nbsp;</label>
							结束时间：
							<input class="easyui-numberbox txt w100" type="text" value="${endTime!}" id="endTime" name="endTime" data-options="required:true,min:0,max:23" >
					</div>
					<br/>
					<div class="fluidbox">
						<p class="p12 p-item">
