		...
		<form class="form-search" action="doForm" method="post" id="queryForm"
			...
			<div class="fluidbox">
				...
				<p class="p3 p-item">
					...
					<select id="q_paymentCode" name="q_paymentCode" class="drop" style="width:100px" panelheight="auto">
						<option value="">-- 全部 --</option>
						<option value="BALANCE">余额支付</option>
						<option value="INTEGRAL">积分支付</option>
						<option value="INTEGRALGROUP">积分组合支付</option>
						<option value="PCECARDPAY">PC一卡通</option>
						<option value="H5ECARDPAY">H5一卡通</option>
						<option value="SAFENESSPAY">平安壹钱包</option>
					</select>
				</p>
			</div>
		</form>
