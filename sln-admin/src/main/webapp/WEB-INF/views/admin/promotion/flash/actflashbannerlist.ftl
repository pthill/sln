...
<script language="javascript">
	...
	//为客户端装配本页面需要的字典数据,多个用逗号分隔
		...
		$("#a-gridAdd").click(function(){
	 		window.location.href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/admin/actflashbanner/banner/add";
		});
		...
		$("#a-gridEdit").click(function(){
			...
			if(selected.state == 1) {
	 		...
	 		window.location.href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/admin/actflashbanner/banner/edit?id="+selected.id;
		});
		...
		$("#a-gridDel").click(function(){
            ...
            $.messager.confirm('提示', '确定删除吗？', function(r){
                if (r){
                    ...
                    $.ajax({
                        type:"POST",
                        url: "${domainUrlUtil.SLN_URL_RESOURCES}/admin/actflashbanner/banner/delete",
                        dataType: "json",
		...
		$("#a-gridUp").click(function(){
	        ...
	        $.messager.confirm('提示', '确定启用吗？', function(r){
	            if (r){
	                ...
	                $.ajax({
	                    type:"POST",
	                    url: "${domainUrlUtil.SLN_URL_RESOURCES}/admin/actflashbanner/banner/up",
	                    dataType: "json",
	                    data: "id="+selected.id,
	                    cache:false,
	                    success:function(data, textStatus){
	    ...
	    $("#a-gridDown").click(function(){
	        ...
	        $.messager.confirm('提示', '确定停用吗？', function(r){
	            if (r){
	                ...
	                $.ajax({
	                    type:"POST",
	                    url: "${domainUrlUtil.SLN_URL_RESOURCES}/admin/actflashbanner/banner/down",
	                    dataType: "json",
	                    data: "id="+selected.id,
	                    cache:false,
	                    success:function(data, textStatus){
...
<div id="searchbar" data-options="region:'north'" style="margin: 0 auto;" border="false">
	<div id="searchbox" class="head-seachbox">
		<h2 class="h2-title">限时抢购首页首页轮播图列表 <span class="s-poar"><a class="a-extend" href="#">收起</a></span></h2>
...
<div data-options="region:'center'" border="false">
	<table id="dataGrid" class="easyui-datagrid"
			data-options="rownumbers:true
						...
						,pageSize:'${pageSize}'
						,fit:true
    					,url:'${(domainUrlUtil.SLN_URL_RESOURCES)!}/admin/actflashbanner/banner/list'
