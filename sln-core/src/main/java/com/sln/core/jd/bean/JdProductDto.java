...
public class JdProductDto implements Serializable {
	...
	public void setParam(java.lang.String param){
		this.param = param != null ? param.toString().replaceAll("'", "\\\\\'"):null;
	}
	...
	public void setIntroduction(java.lang.String introduction){
		this.introduction =introduction != null ? introduction.toString().replaceAll("'", "\\\\\'"):null;
	}
	...
	public void setCategory(String category) {
		if(category != null){
			...
			this.catId = Integer.valueOf(categorys[categorys.length-1]);
		}
