		...
		$("#transtype_ems_info").show();
								...
								<div class="row">
									<div class="col-xs-12 db_box_main_rdinary" id="transtype_mail_info" 
										...
										<div class="rdinary_top">
											默认运费：
											<input name="mail_trans_weight" type="text" precision="2"
											...
											<input name="mail_trans_add_weight" type="text" precision="2"
											...
											<table width="100%" cellpadding="0" cellspacing="0">
												...
												<#list mailList as info>
													<tr index="${info_index}">
														...
														<td><input type="text" class="in" precision="2"
							...
							<div class="db_box_main col-xs-12">
								...
								<div class="col-xs-12 db_box_main_rdinary" id="transtype_express_info" 
									...
									<div class="rdinary_top">
										默认运费：
										<input name="express_trans_weight" type="text" precision="2"
										...
										<input name="express_trans_add_weight" type="text" precision="2"
							...
							<div class="db_box_main col-xs-12">
								...
								<div class="col-xs-12 db_box_main_rdinary" id="transtype_ems_info" 
									...
									<div class="rdinary_top">
										默认运费： 
										<input name="ems_trans_weight" type="text" precision="2"
										...
										<input name="ems_trans_add_weight" class="easyui-numberbox" precision="2"
