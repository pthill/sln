...
//                	return;
        ...
        $("button[type='button'].back").click(function(){
            window.location.href = '${domainUrlUtil.SLN_URL_RESOURCES}/seller/product/chooseCate';
        });
		...
		<div class="page-content">
			...
			<div class="page-breadcrumbs">
				<ul class="breadcrumb">
					...
					<li><a
						href="${domainUrlUtil.SLN_URL_RESOURCES}/seller/product/chooseCate">发布商品</a>
					</li>
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <select id="supplierId" name="supplierId" level="0" required  class="form-control">
							     <#if supplier?? && supplier?size &gt; 0>
                                     <option value="-1">--请选择--</option>
                                    <#list supplier as supplier>
							...
							<div class="col-lg-4">
									...
									<#if tansports??>
										...
										<#list tansports as tansport>
											<option value="${(tansport.id)!'-1' }">${(tansport.transName)!'' }</option>
										</#list>
									<#else>
										<option value="-1">--请选择--</option>
									</#if>
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<@cont.select  id="invoiceRate" 
									codeDiv="INVOICE_RATE" class="form-control" mode="1"/>
							</div>
							<label class="col-lg-6 ejava-errinforight">
								发票税率为百分比
                           	</label>
