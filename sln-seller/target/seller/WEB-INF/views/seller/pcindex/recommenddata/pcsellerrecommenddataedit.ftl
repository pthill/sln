			...
			<div id="bodyhaiheyungu" style="overflow-y: auto; overflow-x: hidden;">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					...
					<form method="post" id="addform" class="form-horizontal"
						action="${domainUrlUtil.SLN_URL_RESOURCES}/seller/pcindex/recommenddata/update"
						...
						<div class="form-group dataLinkDiv" <#if pcSellerRecommendData?? && pcSellerRecommendData.dataType?? && pcSellerRecommendData.dataType != 2>style="display:none;"</#if>>
							...
							<div class="col-lg-4">
								<a href="${domainUrlUtil.SLN_IMAGE_RESOURCES}${(pcSellerRecommendData.image)!''}" class='boxer'>查看图片</a>
							</div>
						</div>
