...
public class SystemRoles implements Serializable {
    ...
    private String            roleType;                                 // 角色类型 1:平台 0:业务管理方 2.商家3.供应商
    /**
     * 角色类型：1、平台
     */
    public final static String ADMIN_TYPE = "1";
    /**
     * 角色类型：0、业务管理方
     */
    public final static String OPERATION_TYPE = "0";
    /**
     * 角色 类型 ：2、商家 
     */
    public final static String BUSINESS_TYPE = "0";
    /**
     * 角色类型 ：3供应商
     */
    public final static String SUPPLIER_TYPE = "1";
