...
<body class="bgf2">
  ...
  <header id="header">
    <div class="flex flex-align-center head-bar bg-col">
      <div class="flex-1 text-left">
        <a href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/tuan.html"><span class="fa fa-angle-left col-f"></span></a>
      </div>
  ...
  <div class="s-container container-padtom" id="container">
    <!--图片 -->
    <div class="detail2">
      <img src="${(domainUrlUtil.SLN_IMAGE_RESOURCES)!}${(actGroup.image)!''}"></div>
    ...
    <div class="fixed-nav">
	    <div class="flex">
	        <div class="flex-1 yellow-cart" ><a href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/product/${(actGroup.productId)!}.html" class="block">对比原商品</a></div>
