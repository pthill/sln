   ...
   <header id="header">
   	  <div class="flex flex-align-center head-bar">
   	  	 <div class="flex-1 text-left">
   	  	 	<a href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/bidding/${(actBidding.id)!0}.html">
      	...
      	<#if seller?? >
            ...
            <div>
           	  <#if product?? && productGoods?? >
	              <a href="${(domainUrlUtil.SLN_URL_RESOURCES)!}/bidding/${(actBidding.id)!0}.html" class="block">
	              <dl class="img-ul cart-ul flex">
	                <dt style="width:80px;height:80px;"><img src="${(domainUrlUtil.SLN_IMAGE_RESOURCES)!}${(actBidding.image)!''}"></dt>
