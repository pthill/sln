	...
	<div class="s-containerr cl70">
	   ...
	   <div class="user-perinfo">
	   	  <div class="perinfor-1 flex flex-pack-center flex-align-center">
	   	  	 ...
	   	  	 <span>${(member.name)!""}&nbsp;(通用积分:${(member.integral)!""}&nbsp;专项积分:${(specialIntegral)!"0"})</span>
	   	  	 </div>
	   	  </div>
	    	...
	    	<h2 class="flex flex-pack-justify sev_regoods">
	    		...
	    		<div class="text-right" style="flex:1">
	    		   <p class="mar-bt"><font class="clr53">状态：
		  				<#if memberGradeIntegralLogs.optType == 6 || memberGradeIntegralLogs.optType == 7 || memberGradeIntegralLogs.optType == 9 || memberGradeIntegralLogs.optType == 12 || memberGradeIntegralLogs.optType == 13||memberGradeIntegralLogs.optType==15>
						减少
						<#else>
						增加
						</#if>
...
$(function(){
	$("#integral_more_json").click(function(){
		...
		var urljson = "${(domainUrlUtil.SLN_URL_RESOURCES)!}/member/integralJson.html?pageNum=" + list_page;
